...
urlpatterns = [
    ...
    path('reset/done/',
         auth_views.PasswordResetDoneView.as_view(template_name='email/password_reset_done.html'),
         name='password_reset_done'),
    re_path(r'reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',
            auth_views.PasswordResetConfirmView.as_view(template_name='email/password_reset_confirm.html'),
    ...
    re_path(r'settings/password/',
            auth_views.PasswordChangeView.as_view(template_name='email/password_change.html'),
            name='password_change'),
    re_path(r'settings/password/done/$', auth_views.PasswordChangeDoneView.as_view(
        template_name='email/password_change_done.html'),
...
# # old stuff
# url(r'^boards/(?P<pk>\d+)/$', views.board_topics, name='board_topics'),  # (?P<pk>\d+) == pk --> board_topics(pk)
# # capture the value into a keyword argument named pk.
